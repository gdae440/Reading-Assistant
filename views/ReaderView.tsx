  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] max-w-5xl mx-auto relative" onClick={() => setModalPosition(null)}>
        ...
        <div className="flex-none p-4 md:p-6 pb-2">
            <div className="flex items-center justify-between bg-white dark:bg-[#1c1c1e] p-1.5 md:p-2 rounded-xl shadow-sm border border-gray-100 dark:border-white/10 overflow-x-auto scrollbar-hide">
                 {/* Left Group */}
                 <div className="flex items-center gap-1 md:gap-2">
                    <button
                        onClick={() => setIsReaderMode(!isReaderMode)}
                        className={`px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-bold flex items-center gap-1.5 transition-colors whitespace-nowrap ${isReaderMode ? 'bg-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300'}`}
                    >
                        {isReaderMode ? '编辑' : '查词'}
                    </button>
                    ...
                    <button
                        ...
                        className={`p-1.5 md:p-2 rounded-lg flex-none transition-colors flex items-center gap-1 ${
                            isBlindMode
                    ...
                    <button
                        ...
                        title="AI 智能分析"
                    >
                         {isAnalyzing ? <svg className="animate-spin w-4 h-4 md:w-5 md:h-5" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                         :
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="p-1.5 md:p-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors rounded-lg"
                            title="图片识别 (OCR)"
                        >
                 ...
                 <div className="flex items-center gap-1 md:gap-2">
                     <button
                        ...
                        className="px-2 py-1.5 md:px-3 md:py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 font-bold text-xs transition-all whitespace-nowrap flex items-center gap-1"
                     >
                         {isTranslating ? (
                             <svg className="animate-spin w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                         ) : (
                             '翻译'
                         )}
                     </button>
                     <button
                        ...
                        disabled={isTranslating}
                        className="px-2 py-1.5 md:px-3 md:py-2 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 hover:bg-purple-200 dark:hover:bg-purple-800/40 font-bold text-xs transition-all whitespace-nowrap flex items-center gap-1"
                     >
                         {isTranslating ? (
                             <svg className="animate-spin w-3 h-3 md:w-4 md:h-4" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                         ) : (
